...
while True:
    ...
    if user is None:
        # draw title
        title = font_large.render('Tic-Tac-Toe', True, write)
        ...
        pygame.draw.rect(screen, write, play_x_button)
        ...
        pygame.draw.rect(screen, write, play_o_button)
        ...
        if pygame.mouse.get_pressed()[0]:
            ...
            for i in range(3):
                ...
                for j in range(3):
                    ...
                    pygame.draw.rect(screen, write, rect, 3)

                    if board[i][j] != tictactoe.EMPTY:
                        move_text = font_move.render(board[i][j], True, write)
            ...
            player = tictactoe.playear(board)
                ...
                for i in range(3):
                    for j in range(3):
                        if board[i][j] == tictactoe.EMPTY and tiles[i][j].collidepoint(mouse):
                            board[i][j] = tictactoe.result(board, (i, j))
            ...
            if game_over:
                ...
                pygame.draw.rect(screen, write, again_button)
